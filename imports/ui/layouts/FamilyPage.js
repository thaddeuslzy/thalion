	...
	render() {
		return (
			<div>
				...
				<div className = "jumbotron familyback">
				  <h2 className = "homehead" > The OYP Family </h2>
				...
				<div className ="row">
				  <div className ="col-sm-12">
				      <div className ="caption">
				        ...
				        <h3 className = "text-center">Come As You Are </h3>

				        <p className = "captionmain"> Seeking to cultivate a closer relationship with God and a community to walk with during this time of uncertainty? Been stagnant in your prayer life, and want to reignite your faith with a group of like-minded young people? Come as you are to our weekly gatherings to find out more! Share your stories, your struggles and joys, pray and worship together as a community. </p>
				...
				<div className = "row">
				  <div className = "col-sm-12">
				     <div className = "caption">
				        ...
				        <h3 className = "text-center">Polytechnic Communities</h3>

				        <p className = "captionmain" > It has been a labour of love, working with the various Catholic communities across the five polytechnics in Singapore. We encourage and support them in their mission on campus and accompany the students in discovering and deepening their faith.  Please read on for more on our formation programs for our poly students. Please read on for more on our formation programs for our poly students.</p>

				        <img className = "familyimg" src="https://i.imgur.com/SXd1zzg.jpg" alt="Random Name"/>

				        <p className = "captionmain"> If you are currently a polytechnic student and would like to get connected, do get in touch with us: </p>

				        <h5 className = "text-center"> Tel: 6285 2571 <br/> email: poly.oyp@catholic.org.sg </h5>
				        ...
				        <div className="row">
				         ...
				         <div className="profile">
    							...
    							<div className="col-sm-3">
      							<h3>NUS</h3><br/>
      							<img className = "school" src="https://i.imgur.com/oTLifOw.png" alt="Random Name"/>
    							</div>

    							<div className="col-sm-3">
	      						<h3>Yale-NUS</h3><br/>
	      						<img className = "school" src="https://i.imgur.com/CpbmRFa.png" alt="Random Name"/>
    							</div>

    							<div className="col-sm-3">
	      						<h3>NTU</h3><br/>
	      						<img className = "school" src="https://i.imgur.com/9fjHUwr.png" alt="Random Name"/>
    							</div>

    							<div className="col-sm-3">
      							<h3>SMU</h3><br/>
      							<img className = "school" src="https://i.imgur.com/qh35ctq.png " alt="Random Name"/>
    							</div>
				         ...
				         <div className="profile">
    							<div className="col-sm-3">
      							<h3>SUTD</h3><br/>
      							<img className = "school" src="https://i.imgur.com/AdIETCT.png" alt="Random Name"/>
    							</div>

    							<div className="col-sm-3">
      							<h3>SIM</h3><br/>
      							<img className = "school" src="https://i.imgur.com/9A6QZxH.png" alt="Random Name"/>
    							</div>

    							<div className="col-sm-3">
	      						<h3>SIT</h3><br/>
	      						<img className = "school" src="https://i.imgur.com/89LrhgK.png" alt="Random Name"/>
    							</div>

    							<div className="col-sm-3">
	      						<h3>JCU</h3><br/>
	      						<img className = "school" src="https://i.imgur.com/DDwUFdK.png" alt="Random Name"/>
    							</div>
				...
				<div className = "row">
				  <div className="col-sm-12">
				      <div className="caption">
				        ...
				        <img className = "familyimg" src="https://i.imgur.com/AjjPmzd.jpg" alt="Random Name"/>
				...
				<div className = "row">
				  <div className="col-sm-12">
				      <div className="caption">
				        ...
				        <h3 className = "text-center"> Vinnea Domini</h3>		        

				        <p className = "captionmain"> We are a community of professional Catholic parish-based youth workers from across the diocese along with youth coordinators from the Office for Young People. We meet once a month to share our lives and pray </p>

				        <img className = "familyimg" src="https://i.imgur.com/7Na7ri3.jpg" alt="Random Name"/>
