				  ...
				  <div className="col-sm-6 ">
				    <div className="thumbnail">
				      <div className="caption">
				        ...
				        <p className = "text-center"> <a href="#" className="btn btn-default" role="button">See More</a></p>
				      </div>
				    </div>
				  </div>
				  ...
				  <div className="col-sm-6">
				    <div className="thumbnail">
				      <div className="caption">
				        <h3>Support Us!</h3>
				        <p className = "captionbody">...</p>
				        <p className = "text-center"> <a href="#" className="btn btn-default" role="button">I Would Like to Support!</a></p>
				      </div>
				    </div>
				  </div>
